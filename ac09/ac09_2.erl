...
expand_input([], {0, Repeat}, Expanded, Buffer) -> 
	expand_input( lists:reverse(string:copies(Buffer, Repeat)) ++ [], {0, 0}, Expanded, []);
...
expand_input(String, {0, Repeat}, Expanded, Buffer) ->
	...
	expand_input(lists:reverse(EmptyBuffer) ++ String, {0, 0}, Expanded, []);
