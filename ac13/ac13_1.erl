...
solve(XTarget, YTarget, FavNum) ->
	Maze = initialize_maze(1000,1000,FavNum),
	find_target(Maze, {{1,1}, 0}, {XTarget,YTarget}, queue:new()).
...
find_target(_Maze, {TargetPosition, Distance}, TargetPosition, _ToVisit) -> Distance;
find_target(Maze, {Position, Distance}, TargetPosition, ToVisit) ->
	...
	find_target(Maze, NextPosition, TargetPosition, NextToVisit).
